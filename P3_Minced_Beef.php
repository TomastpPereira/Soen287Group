...
<div style="padding-left: 24px; padding-right: 24px;">
    ...
    <div id="productInfo">
        ...
        <img src="images/minced-beef.jpg"
             id="picture" alt="Minced Beef"/>

        <div id="productDescription" style="margin: 0px 0px 25px 25px; max-width: 500px;">
            <p id="item" style="text-align: center; font-weight: bold"> Minced Beef </p>
            <p>
